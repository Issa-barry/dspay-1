...
<template>
    <div class="card">
        <span class="text-surface-900 dark:text-surface-0 text-xl font-bold mb-6 block">Ajouter 1 point de retrait</span>
        <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12 lg:col-span-2">
                <!-- <div class="text-surface-900 dark:text-surface-0 font-medium text-xl mb-4">Profile</div> -->
                <p class="m-0 p-0 text-surface-600 dark:text-surface-200 leading-normal mr-4">Information de l'agence.</p>
            </div>
